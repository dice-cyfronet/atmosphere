module Atmosphere
  class VmtMigrator
    def initialize(virtual_machine_template, source_compute_site, destination_compute_site)
      ...
      if @source_compute_site.technology == 'openstack'
        ...
        if migrator_class != nil
          Sidekiq::Client.push(
            ...
            'args' => [@virtual_machine_template.id_at_site, @destination_compute_site.site_id])
        end
      end
    end
  end
