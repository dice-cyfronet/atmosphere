  ...
  factory :compute_site, aliases: [:openstack_compute_site] do |f|
    ...
    trait :openstack_flavors do
      virtual_machine_flavors { [
        build(:virtual_machine_flavor, flavor_name: '1', cpu: 1, memory: 512, hdd: 30, hourly_cost: 10),
        build(:virtual_machine_flavor, flavor_name: '2', cpu: 1, memory: 2048, hdd: 30, hourly_cost: 20),
        build(:virtual_machine_flavor, flavor_name: '3', cpu: 2, memory: 4096, hdd: 30, hourly_cost: 30),
        build(:virtual_machine_flavor, flavor_name: '4', cpu: 4, memory: 8192, hdd: 30, hourly_cost: 40),
        build(:virtual_machine_flavor, flavor_name: '5', cpu: 8, memory: 16384, hdd: 30, hourly_cost: 50)
      ] }
    end

    trait :amazon_flavors do
      virtual_machine_flavors { [
        build(:virtual_machine_flavor, flavor_name: 't1.micro', cpu: 1, memory: 615, hdd: 0, hourly_cost: 60),
        build(:virtual_machine_flavor, flavor_name: 'm1.small', cpu: 1, memory: 1740, hdd: 150, hourly_cost: 70),
        build(:virtual_machine_flavor, flavor_name: 'm1.medium', cpu: 2, memory: 3840, hdd: 400, hourly_cost: 80),
        build(:virtual_machine_flavor, flavor_name: 'm1.large', cpu: 4, memory: 7680, hdd: 840, hourly_cost: 90),
        build(:virtual_machine_flavor, flavor_name: 'm1.xlarge', cpu: 8, memory: 15360, hdd: 1680, hourly_cost: 100)
      ] }
    end
