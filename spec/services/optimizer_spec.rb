...
describe Optimizer do
  ...
  context 'new appliance created' do
    ...
    context 'development mode' do
      ...
      it 'does not reuse available vm' do
        ...
        appl1 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
        appl2 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: dev_appliance_set, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
      ...
      it 'does not reuse available vm if it is in dev mode' do
          tmpl_of_shareable_at
          appl1 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: dev_appliance_set, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
          appl2 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf2, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
          vms = VirtualMachine.all
          expect(vms.size).to eql 2
          vm_1 = vms.first
          vm_2 = vms.last
      ...
      context 'sets vm name' do
        ...
        it 'to appliance name if it is not blank' do
          appliance = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: dev_appliance_set, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst, name: 'name full appliance')
        ...
        it 'to appliance type name if appliance name is blank' do
          appliance = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: dev_appliance_set, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
    ...
    context 'shareable appliance type' do
      ...
      context 'vm cannot be reused' do
        ...
        it 'instantiates a new vm if there are no vms at all' do
          appl = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: shareable_appl_type, appliance_configuration_instance: create(:appliance_configuration_instance))
          vms = VirtualMachine.all
        ...
        it 'does not reuse avaiable vm if appliances use config with equal payload and different ids' do
          ...
          appl1 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst)
          appl2 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf2, appliance_type: shareable_appl_type, appliance_configuration_instance: create(:appliance_configuration_instance, payload: config_inst.payload))
          vms = VirtualMachine.all
          expect(vms.size).to eql 2
          vm_1 = vms.first
          vm_2 = vms.last
    ...
    context 'not shareable appliance type' do
      ...
      it 'instantiates a new vm although vm with given conf is already running' do
        ...
        config_inst = create(:appliance_configuration_instance)
        appl1 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: not_shareable_appl_type, appliance_configuration_instance: config_inst)
        appl2 = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf2, appliance_type: not_shareable_appl_type, appliance_configuration_instance: config_inst)
        vms = VirtualMachine.all
        expect(vms.size).to eql 2
        appl1.reload
        appl2.reload
  ...
  context 'no template is available' do
    ...
    it 'sets appliance to unsatisfied state' do
      appl = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: at, appliance_configuration_instance: create(:appliance_configuration_instance))
      appl.reload
      ...
      context 'appliance type preferences specified' do
        ...
        context 'preferences exceeds resources of avaiable flavors' do
          ...
          it 'sets state explanation' do
            ...
            appl = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: appl_type, appliance_configuration_instance: create(:appliance_configuration_instance), name: 'my service')
          ...
          it 'sets appliance as unsatisfied' do
            appl = Appliance.create(fund: fund, prepaid_until: Time.now, appliance_set: wf, appliance_type: appl_type, appliance_configuration_instance: create(:appliance_configuration_instance))
