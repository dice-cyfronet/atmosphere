  ...
  context 'new appliance created' do
    ...
    context 'development mode' do
      ...
      it 'does not reuse available vm if it is in dev mode' do
        ...
        appl2 = Atmosphere::Appliance.new(appliance_set: wf2, appliance_type: shareable_appl_type, appliance_configuration_instance: config_inst, fund: fund, compute_sites: Atmosphere::ComputeSite.all)
        subject = Atmosphere::OptimizationStrategy::Default.new(appl2)
